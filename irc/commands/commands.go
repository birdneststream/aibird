...
// It can optionally filter by channel capabilities (ai, sd, sound)
func GetAllCommands(config settings.AiBird, enableAi, enableSd, enableSound bool, isAdmin, isOwner bool) []string {
	var commands []string
...
func GetAllCommandsUnfiltered(config settings.AiBird) []string {
	return GetAllCommands(config, true, true, true, true, true)
}
...
func IsValidCommandForChannel(command string, config settings.AiBird, enableAi, enableSd, enableSound bool, isAdmin, isOwner bool) bool {
	commands := GetAllCommands(config, enableAi, enableSd, enableSound, isAdmin, isOwner)
