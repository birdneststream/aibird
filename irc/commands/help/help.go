	...
	return []Help{
		{
			...
			Arguments: []Arguments{
				...
				{Argument: "setAiService", Help: "Set the AI service. Options: llamacpp, openrouter", Values: "llamacpp, openrouter"},
				{Argument: "clearAiService", Help: "Reset the AI service to default (llamacpp).", Values: ""},
			},
			Queueable: true,
		},
		{
	...
	return []Help{
		{
			...
			Arguments: []Arguments{
				...
				{Argument: "--aiService", Help: "Set the AI service.", Values: "llamacpp, openrouter"},
